  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="updateFloorForm" action="{{ route('floors.update') }}" >
            ...
            <div class="form-group">
                ...
                <input type="number" id="floorNumber" name="number" class="form-control">
            </div>

            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" id="floorName" name="name" class="form-control">
            </div>
