...
<!-- Modal Create -->
<div class="modal fade" id="createInstructorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Instructor / Coach</h5>
      ...
      <div class="modal-body">
        ...
        <form id="createInstructorForm" action="{{ route('instructors.create') }}" >
